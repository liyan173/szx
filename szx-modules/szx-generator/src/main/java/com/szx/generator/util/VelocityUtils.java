package com.szx.generator.util;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.convert.Convert;
import cn.hutool.core.lang.Dict;
import com.szx.common.mybatis.enums.DataBaseType;
import com.szx.generator.constant.GenConstants;
import com.szx.common.core.utils.DateUtils;
    ...
    public static HashSet<String> getImportList(GenTable genTable) {
        ...
        for (GenTableColumn column : columns) {
            if (!column.isSuperColumn() && GenConstants.TYPE_DATE.equals(column.getJavaType())) {
                ...
                importList.add("com.szx.common.translation.annotation.Translation");
                importList.add("com.szx.common.translation.constant.TransConstant");
            }
        }
        return importList;
    }
